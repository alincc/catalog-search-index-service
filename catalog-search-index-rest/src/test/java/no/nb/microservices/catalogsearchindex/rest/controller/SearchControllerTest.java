...
public class SearchControllerTest {
    ...
    @Before
    public void init() {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/id/search?q=q");
    ...
    public void testSearchWithin() {
        ...
        assertThat("Should hava a self reference", searchWithin.getBody().getId().getHref(), is("http://localhost/id/search?q=q"));
